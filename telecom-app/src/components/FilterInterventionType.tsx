...
const FilterInterventionType:React.FC = () => {
  const { typeI } = useParams<{ typeI: string }>();
  const [interventions, setInterventions] = useState<Intervention[]>([]);
  useEffect(() => {
    console.log("Received Type:", typeI);
  }, [typeI]);
  ...
  return (
    <div>
      <h2>Liste des interventions selon le type "{typeI}"</h2>
...
export default FilterInterventionType;
